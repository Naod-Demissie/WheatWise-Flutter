  ...
  Widget build(BuildContext context) {
    return BlocListener<MobileDiagnosisBloc, MobileDiagnosisState>(
      listener: (context, mobileDiagnosisState) async {
        ...
        if (mobileDiagnosisState is MultipleMobileDiagnosisSuccessState) {
            ...
            onPressed: () async {
              ...
              if (files.isNotEmpty) {
                ...
                if (files.length > 1) {
                  ...
                  BlocProvider.of<MobileDiagnosisBloc>(context).add(
                    StartMultipleMobileDiagnosisEvent(
                      fileNames: fileNames,
                      filePaths: filePaths,
                      confidenceScores: confidenceScores,
                      mobileDiagnoses: labels,
                    ),
                  );
                  BlocProvider.of<DiagnosisStatisticsBloc>(context)
                      .add(const LoadDiagnosisStatisticsEvent());
...
// // Working home screen: cascade of snack bar
// import 'dart:io';
